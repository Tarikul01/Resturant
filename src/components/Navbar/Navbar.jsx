...
const Navbar = () =>{
  ...
  <nav className='app__navbar'>
      ...
      <ul className="app__navbar-links">
        <li className="p__opensans"><a href='#home'>Home</a>
        </li>
        <li className="p__opensans"><a href='#about'>About</a>
        </li>
        <li className="p__opensans"><a href='#menu'>Menu</a>
        </li>
        <li className="p__opensans"><a href='#awards'>Awards</a>
        </li>
      ...
      <div className="app__navbar-login">
       <a href="#login" className="p__opensans">Log In / Register</a>
        <div></div>
      <a href="#booke" className="p__opensans">Book Table</a>
      </div>
